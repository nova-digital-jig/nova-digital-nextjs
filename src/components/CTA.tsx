  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 text-center">
        ...
        <p
          className="cta-sub mt-10 text-[#666] text-base md:text-lg max-w-md mx-auto leading-relaxed"
          style={{
            fontFamily: 'var(--font-jakarta), sans-serif',
            opacity: 0,
          }}
        >
          We&apos;ll have a proposal within 24 hours.
        </p>
        ...
        >
          ...
          <MagneticButton
            ...
            className="inline-flex items-center gap-3 px-10 py-5 bg-transparent text-[#F0EDE6] rounded-full text-base font-medium tracking-[0.03em] border border-white/15 hover:border-white/40 transition-all duration-300"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
